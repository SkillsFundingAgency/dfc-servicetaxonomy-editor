...
{
    public class CosmosDbTaxonomyPartEmbeddedContentItemsGraphSyncer : CosmosDbEmbeddedContentItemsGraphSyncer, ITaxonomyPartEmbeddedContentItemsGraphSyncer
    {
        public CosmosDbTaxonomyPartEmbeddedContentItemsGraphSyncer(
            IContentDefinitionManager contentDefinitionManager,
            //todo: put one in the context??
            ISyncNameProvider statelessSyncNameProvider,
            IServiceProvider serviceProvider,
            ILogger<CosmosDbTaxonomyPartEmbeddedContentItemsGraphSyncer> logger)
