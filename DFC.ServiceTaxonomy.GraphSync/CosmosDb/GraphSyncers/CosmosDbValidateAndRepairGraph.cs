...
namespace DFC.ServiceTaxonomy.GraphSync.CosmosDb.GraphSyncers
{
    public class CosmosDbValidateAndRepairGraph : IValidateAndRepairGraph
    {
        ...
        private readonly ILogger<CosmosDbValidateAndRepairGraph> _logger;
        private IGraph? _currentGraph;
        private static readonly SemaphoreSlim _serialValidation = new SemaphoreSlim(1, 1);

        public CosmosDbValidateAndRepairGraph(IEnumerable<IContentItemGraphSyncer> itemSyncers,
            ...
            ILogger<CosmosDbValidateAndRepairGraph> logger)
        {
