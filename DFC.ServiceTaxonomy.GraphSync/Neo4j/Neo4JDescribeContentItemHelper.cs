...
{
    public class Neo4JDescribeContentItemHelper : IDescribeContentItemHelper
    {
        ...
        public Neo4JDescribeContentItemHelper(
            ...
            IDescribeRelationshipsContext context)
        {
            ...
            List<IQuery<object?>> commandsToReturn = uniqueCommands
                .Select(c => new Neo4JNodeAndNestedOutgoingRelationshipsQuery(c!)).Cast<IQuery<object?>>().ToList();
            ...
            commandsToReturn.Add(new Neo4JSubgraphQuery(
                context.SourceNodeLabels,
                context.SourceNodeIdPropertyName,
                context.SourceNodeId,
                Neo4JSubgraphQuery.RelationshipFilterIncoming,
