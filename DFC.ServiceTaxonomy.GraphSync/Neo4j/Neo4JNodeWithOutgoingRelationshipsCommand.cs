...
{
    public abstract class Neo4JNodeWithOutgoingRelationshipsCommand : INodeWithOutgoingRelationshipsCommand
    {
        ...
        public static implicit operator Query(Neo4JNodeWithOutgoingRelationshipsCommand c) => c.Query;
