...
namespace DFC.ServiceTaxonomy.GraphSync.Neo4j.Queries
{
    ...
    public class Neo4JNodeAndOutRelationshipsAndTheirInRelationshipsQuery : IQuery<INodeAndOutRelationshipsAndTheirInRelationships?>
    {
        private IEnumerable<string> NodeLabels { get; }
        private string IdPropertyName { get; }
        private object IdPropertyValue { get; }

        public Neo4JNodeAndOutRelationshipsAndTheirInRelationshipsQuery(
