...
namespace DFC.ServiceTaxonomy.GraphSync.Neo4j.Queries.Models
{
    ...
    public class Neo4JNodeWithOutgoingRelationships : INodeWithOutgoingRelationships
    {
        public INode SourceNode { get; set; }
        public IEnumerable<IOutgoingRelationship> OutgoingRelationships { get; set; }

        public Neo4JNodeWithOutgoingRelationships(INode sourceNode, IEnumerable<(IRelationship relationship, INode destinationNode)> outgoingRelationships)
        {
        ...
        public IReplaceRelationshipsCommand ToReplaceRelationshipsCommand(ISyncNameProvider syncNameProvider)
        {
            ...
            IReplaceRelationshipsCommand replaceRelationshipsCommand = new Neo4JReplaceRelationshipsCommand
            {
