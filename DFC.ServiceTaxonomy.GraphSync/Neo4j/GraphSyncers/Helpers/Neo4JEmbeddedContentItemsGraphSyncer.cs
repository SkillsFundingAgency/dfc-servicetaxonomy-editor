...
namespace DFC.ServiceTaxonomy.GraphSync.Neo4j.GraphSyncers.Helpers
{
    public abstract class Neo4JEmbeddedContentItemsGraphSyncer : IEmbeddedContentItemsGraphSyncer
    {
        ...
        protected Neo4JEmbeddedContentItemsGraphSyncer(
            ...
            IAllowSync allowSync)
        {
            ...
            INodeAndOutRelationshipsAndTheirInRelationships? existing = (await context.GraphReplicaSet.Run(
                    new Neo4JNodeAndOutRelationshipsAndTheirInRelationshipsQuery(
                ...
                foreach (object destinationNodeIdPropertyValue in removingRelationship.DestinationNodeIdPropertyValues)
                {
                    ...
                    var nonTwoWayIncomingRelationshipsToEmbeddedItems = existingForRemoving
                        ...
                        .Where(ir => !ir.Relationship.Properties.ContainsKey(
                            Neo4JNodeWithOutgoingRelationshipsCommand.TwoWayRelationshipPropertyName));
        ...
        private static IEnumerable<KeyValuePair<string, object>> TwoWayRelationshipProperties { get; } =
            new Dictionary<string, object> { { Neo4JNodeWithOutgoingRelationshipsCommand.TwoWayRelationshipPropertyName, true } };
