...
namespace DFC.ServiceTaxonomy.GraphSync.Neo4j.GraphSyncers
{
    public class Neo4JValidateAndRepairGraph : IValidateAndRepairGraph
    {
        ...
        private readonly ILogger<Neo4JValidateAndRepairGraph> _logger;
        private IGraph? _currentGraph;
        private static readonly SemaphoreSlim _serialValidation = new SemaphoreSlim(1, 1);

        public Neo4JValidateAndRepairGraph(IEnumerable<IContentItemGraphSyncer> itemSyncers,
            ...
            ILogger<Neo4JValidateAndRepairGraph> logger)
        {
            ...
            IContentItemVersion contentItemVersion)
        {
            ...
            ISubgraph? nodeWithRelationships = (await _currentGraph!.Run(
                new Neo4JSubgraphQuery(nodeLabels, _syncNameProvider.IdPropertyName(), nodeId)))
                .FirstOrDefault();
