...
namespace DFC.ServiceTaxonomy.GraphSync.Neo4j.GraphSyncers.Parts.Taxonomy
{
    public class Neo4JTaxonomyPartEmbeddedContentItemsGraphSyncer : Neo4JEmbeddedContentItemsGraphSyncer, ITaxonomyPartEmbeddedContentItemsGraphSyncer
    {
        public Neo4JTaxonomyPartEmbeddedContentItemsGraphSyncer(
            IContentDefinitionManager contentDefinitionManager,
            //todo: put one in the context??
            ISyncNameProvider statelessSyncNameProvider,
            IServiceProvider serviceProvider,
            ILogger<Neo4JTaxonomyPartEmbeddedContentItemsGraphSyncer> logger)
