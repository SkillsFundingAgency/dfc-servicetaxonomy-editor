...
namespace DFC.ServiceTaxonomy.GraphSync.Neo4j.GraphSyncers.Parts.Flow
{
    public class Neo4JFlowPartEmbeddedContentItemsGraphSyncer : Neo4JEmbeddedContentItemsGraphSyncer, IFlowPartEmbeddedContentItemsGraphSyncer
    {
        ...
        public Neo4JFlowPartEmbeddedContentItemsGraphSyncer(
            IContentDefinitionManager contentDefinitionManager,
            ISyncNameProvider statelessSyncNameProvider,
            IServiceProvider serviceProvider,
            ILogger<Neo4JFlowPartEmbeddedContentItemsGraphSyncer> logger)
