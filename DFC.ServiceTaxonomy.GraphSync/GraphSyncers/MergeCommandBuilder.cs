...
{
    public class MergeCommandBuilder : IMergeGraphSyncer
    {
        ...
        public async Task<IMergeGraphSyncer?> SyncEmbedded(ContentItem contentItem)
        {
            ...
            var embeddedMergeGraphSyncer = (MergeCommandBuilder)embeddedMergeContext.MergeGraphSyncer;

            if (!embeddedMergeGraphSyncer._graphSyncHelper.GraphSyncPartSettings.PreexistingNode)
            {
                await ((MergeCommandBuilder)embeddedMergeContext.MergeGraphSyncer).SyncEmbedded();
            }
