...
{
    public class ContentTypeUpdated : Activity, IActivity
    {
        public ContentTypeUpdated(
            IDeleteGraphSyncer deleteGraphSyncer,
            IStringLocalizer<ContentTypeUpdated> localizer,
            INotifier notifier,
        ...
        public override string Name => nameof(ContentTypeUpdated);
        public override LocalizedString DisplayText => T["An event that occurs when a Content Type is Updated"];
