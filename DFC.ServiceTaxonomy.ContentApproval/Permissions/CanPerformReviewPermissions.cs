...
namespace DFC.ServiceTaxonomy.ContentApproval.Permissions
{
    public class CanPerformReviewPermissions : IPermissionProvider
    {
        ...
        public static readonly Permission CanPerformReviewPermission = new Permission(nameof(CanPerformUXReviewPermission), "Can perform UX review", new []{CanPerformUXReviewPermission, CanPerformSMEReviewPermission, CanPerformContentDesignReviewPermission, CanPerformApprovalPermissions.CanPerformStakeholderApprovalPermission});
