...
{
    public class OnetSkillContentItemBuilder
    {
        ...
        public OnetSkillContentItemBuilder(
        ...
        public OnetSkillContentItemBuilder Build()
        {
            LoadONetSkillRanks(_jobProfileReferenceDataModel.JobProfileExcelWorkbook);
            ImportTraits(
                _jobProfileReferenceDataModel.JobCategoryBuilder.JobCategoryContentItemIdDictionary,
        ...
        public void BuildONetSkills(ReferenceData jobProfileReferenceDataModel,  XSSFWorkbook dysacWorkbook)
        {
            ...
            var _oNetOccupationalCodeContentItems = jobProfileReferenceDataModel.ONetOccupationalCodeContentItemBuilder.ONetOccupationalCodeContentItems;
        ...
        private void LoadONetSkillRanks(XSSFWorkbook jobProfileWorkbook)
        {
            ...
            for (int i = 1; i <= sheet.LastRowNum; i++)
            {
                ...
                var occCodeToSocCodeMap = _jobProfileReferenceDataModel.ONetOccupationalCodeContentItemBuilder.ONetOccupationalCodeToSocCodeMappingDictionary;
