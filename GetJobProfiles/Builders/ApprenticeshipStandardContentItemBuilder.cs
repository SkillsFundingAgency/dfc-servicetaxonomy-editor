...
{
    public class ApprenticeshipStandardContentItemBuilder
    {
        ...
        public ApprenticeshipStandardContentItemBuilder( string[] apprenticeshipStandards )
        {
        ...
        public ApprenticeshipStandardContentItemBuilder Build(
            ...
            ReferenceData jobProfileReferenceDataModel)
        {
            ...
            ApprenticeshipStandardContentItems = apprenticeshipStandards.Select(standard => new ApprenticeshipStandardContentItem(standard.Name, jobProfileSettingsDataModel.Timestamp, _standardsDictionary[standard.Name])
            {
                EponymousPart = new ApprenticeshipStandardPart
                {
                    ...
                    {
                        ContentItemIds = standard.Level.HasValue ? new List<string> { jobProfileReferenceDataModel.QcfLevelContentItemBuilder.QcfLevelDictionary[standard.Level.ToString()] } : new List<string>()
                    },
                    Type = new TextField(standard.Type)
                }
            });

            AssignStandardsToJobProfiles(jobProfileReferenceDataModel.JobProfileExcelWorkbook, jobProfileReferenceDataModel.JobProfileContentItemBuilder.jobProfileContentItems);
