...
{
    public class ONetOccupationalCodeContentItemBuilder
    {
        ...
        public ONetOccupationalCodeContentItemBuilder(string[] codes)
        {
            _codesToProcess = codes;
            _processAll = !_codesToProcess.Any();
        }

        public ONetOccupationalCodeContentItemBuilder Build(XSSFWorkbook workbook, string timestamp)
        {
