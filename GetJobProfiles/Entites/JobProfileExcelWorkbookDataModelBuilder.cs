...
namespace GetJobProfiles.Entities
{
    ...
    {
        public Dictionary<string, JobProfileExcelWorkbookColumnsModel> JobProfileExcelWorkbookColumnsDataModelDictionary
        {
            get;
            set;
        } = new Dictionary<string, JobProfileExcelWorkbookColumnsModel>();

        public Dictionary<string, JobProfileExcelWorkbookColumnsModel> Import(XSSFWorkbook workbook)
        {
            ...
            var jobProfileSpreadsheet = new JobProfileExcelWorkbookColumnsModel();
            ...
            for (int i = 1; i <= jobProfileWorksheet.LastRowNum; ++i)
            {
                ...
                jobProfileSpreadsheet = new JobProfileExcelWorkbookColumnsModel();
            }
