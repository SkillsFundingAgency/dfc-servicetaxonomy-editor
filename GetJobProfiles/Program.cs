...
namespace GetJobProfiles
{
    ...
    static class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            string jsonString = File.ReadAllText($"appsettings.Development.json");
        ...
        private static async Task RunImport( HttpClient httpClient, string masterRecipeName,  string timestamp, string jobProfilesToImport, bool excludeGraphMutators)
        {
            ...
            JobProfileConverter converter = new JobProfileConverter(client, socCodeDictionary, oNetDictionary, timestamp);
            await converter.Go(skip, take, napTimeMs, jobProfilesToImport);
            JobProfileContentItem[] jobProfiles = converter.JobProfiles.ToArray();
