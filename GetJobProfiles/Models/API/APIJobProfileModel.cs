...
{
    public class APIJobProfileModel
    {
        public string Title;
        ...
        public string AlternativeTitle; // csv. we'll probably ignore these, and serve up esco's alt labels instead. GG: Mar 2021: ECSO is out, get the alternative label from JobProfileAPI
        public string HiddenAlternativeTitle; // csv. get the hidden alternative label from JobProfileAPI
