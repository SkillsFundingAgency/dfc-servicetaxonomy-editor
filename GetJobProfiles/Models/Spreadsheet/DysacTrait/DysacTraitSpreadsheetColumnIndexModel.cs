...
{
    public class DysacTraitSpreadsheetColumnIndexModel
    {
        // Index of the columns in the Trait spreadsheet on the dysac workbook
        ...
        public int JobProfileCategoriesColumnIndex { get; set; }

        // DescriptionColumnIndex
        public int DescriptionColumnIndex { get; set; }

        // ResultDisplayTextColumnIndex
        public int ResultDisplayTextColumnIndex { get; set; }
    }
}
