...
{
    public class UniversityRequirementSpreadsheetColumnIndexModel
    {
        // Index of the columns in the Sitefinity UniversityRequirement spreadsheet on the exported Job Profile workbook
