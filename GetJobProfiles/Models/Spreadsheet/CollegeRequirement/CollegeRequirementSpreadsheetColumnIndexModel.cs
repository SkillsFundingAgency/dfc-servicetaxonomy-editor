namespace GetJobProfiles.Models.Spreadsheet.CollegeRequirement
{
    public class CollegeRequirementSpreadsheetColumnIndexModel
    {
        // Index of the columns in the Sitefinity CollegeRequirement spreadsheet on the exported Job Profile workbook
