...
{
    public class RestrictionSpreadsheetColumnIndexModel
    {
        // Index of the columns in the Sitefinity Restriction spreadsheet on the exported Job Profile workbook
