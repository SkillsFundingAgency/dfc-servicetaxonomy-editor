...
{
    public class ApprenticeshipLinkSpreadsheetColumnIndexModel
    {
        // Index of the columns in the Sitefinity ApprenticeshipLink spreadsheet on the exported Job Profile workbook
