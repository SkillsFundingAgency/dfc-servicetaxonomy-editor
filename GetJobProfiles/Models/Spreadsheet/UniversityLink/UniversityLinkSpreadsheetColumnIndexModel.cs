namespace GetJobProfiles.Models.Spreadsheet.UniversityLink
{
    public class UniversityLinkSpreadsheetColumnIndexModel
    {
        // Index of the columns in the Sitefinity UniversityLink worksheet on the exported Job Profile workbook
