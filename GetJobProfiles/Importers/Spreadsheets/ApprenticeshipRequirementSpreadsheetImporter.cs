...
using System.Linq;
using GetJobProfiles.Models.Spreadsheet.ApprenticeshipRequirement;
using NPOI.XSSF.UserModel;

namespace GetJobProfiles.Importers.Spreadsheets
{
    public class ApprenticeshipRequirementSpreadsheetImporter
    {
        // The ApprenticeshipRequirement dictionary of imported data in key/value format where the value is row model for the given spreadsheet
        public IReadOnlyDictionary<string, ApprenticeshipRequirementSpreadsheetRowModel> ApprenticeshipRequirementDictionary { get; private set; }

        // The name of the Spreadsheet to import
        private const string SpreadsheetName = "ApprenticeshipRequirement";

        public IReadOnlyDictionary<string, ApprenticeshipRequirementSpreadsheetRowModel> Import(XSSFWorkbook spreadsheetWorkbook)
        {
            // Initialise the dictionary that will hold the Spreadsheet row/columns model
            var spreadsheetDictionary = new Dictionary<string, ApprenticeshipRequirementSpreadsheetRowModel>();
            ...
            var spreadsheetColumnIndexModel = new ApprenticeshipRequirementSpreadsheetColumnIndexModel();

            // Initialise a spreadsheet row model so that we can use the column names to lookup the column indexes
            var spreadsheetRowModel = new ApprenticeshipRequirementSpreadsheetRowModel();
            ...
            IReadOnlyDictionary<string, ApprenticeshipRequirementSpreadsheetRowModel> readonlySpreadsheet = spreadsheetDictionary;
        ...
        private void InitialiseTheSpreadsheetColumnIndexes(
            ...
            ApprenticeshipRequirementSpreadsheetColumnIndexModel spreadsheetColumnIndexModel,
            ApprenticeshipRequirementSpreadsheetRowModel spreadsheetRowModel)
        {
        ...
        private ApprenticeshipRequirementSpreadsheetRowModel GetTheSpreadsheetRowData(
            NPOI.SS.UserModel.IRow spreadsheetRow,
            ApprenticeshipRequirementSpreadsheetColumnIndexModel spreadsheetColumnIndexModel)
        {
            ApprenticeshipRequirementSpreadsheetRowModel spreadsheetRowModel = null;

            if (spreadsheetRow != null)
            {
                spreadsheetRowModel = new ApprenticeshipRequirementSpreadsheetRowModel();
