...
namespace DFC.ServiceTaxonomy.JobProfiles.Module.EFDataModels
{
    ...
    public partial class WorkContextCategory
    {
        [Key]
        [Column("element_id")]
        [StringLength(20)]
        ...
        [InverseProperty(nameof(ContentModelReference.WorkContextCategories))]
        public virtual ContentModelReference Element { get; set; }
        [ForeignKey(nameof(ScaleId))]
        [InverseProperty(nameof(ScalesReference.WorkContextCategories))]
