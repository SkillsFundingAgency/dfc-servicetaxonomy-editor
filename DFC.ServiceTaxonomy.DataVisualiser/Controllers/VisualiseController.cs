...
namespace DFC.ServiceTaxonomy.DataVisualiser.Controllers
{
    public class VisualiseController : Controller
    {
        ...
        private readonly IVisualiseDataSyncer _visualiseDataSyncer;
        ...
        public VisualiseController(
            ...
            IVisualiseDataSyncer visualiseDataSyncer,
            ...
            INodeContentItemLookup nodeContentItemLookup)
        {
            ...
            _visualiseDataSyncer = visualiseDataSyncer;
        ...
        {
            var subgraph = await _visualiseDataSyncer.GetVisualisationSubDataSync(contentItemId, graphName, _contentItemVersion!);
