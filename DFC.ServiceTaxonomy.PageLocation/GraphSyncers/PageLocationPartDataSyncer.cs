...
{
    public class PageLocationPartDataSyncer : ContentPartDataSyncer
    {
        ...
        public PageLocationPartDataSyncer(IPageLocationClonePropertyGenerator generator, IContentItemsService contentItemsService, IContentDefinitionManager contentDefinitionManager)
        {
            ...
            IValidateAndRepairContext context)
        {
            ...
            if (settings.DisplayRedirectLocationsAndDefaultPageForLocation)
            {
                ...
                (matched, failureReason) = context.DataSyncValidationHelper.ContentMultilineStringPropertyMatchesNodeProperty(
                    RedirectLocationsPropertyName,
                    content,
