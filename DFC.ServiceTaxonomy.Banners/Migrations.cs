...
namespace DFC.ServiceTaxonomy.Banners
{
    ...
    public class Migrations : DataMigration
    {
        ...
        public int Create()
        {
            _contentDefinitionManager.AlterPartDefinitionAsync(nameof(BannerPart), part => part
                .Attachable()
                .WithDescription("Adds banner related properties to a content item.")
            );
            SchemaBuilder.CreateMapIndexTableAsync<BannerPartIndex>(table => table
            ...
            SchemaBuilder.AlterIndexTableAsync<BannerPartIndex>(table => table
                .CreateIndex(
