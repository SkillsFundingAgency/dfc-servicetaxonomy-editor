...
namespace DFC.ServiceTaxonomy.GraphLookup.Neo4J.Queries
{
    ...
    public class Neo4JGetPropertyOnNodeQuery : IQuery<string?>
    {
        ...
        public Neo4JGetPropertyOnNodeQuery(string nodeLabel, string matchPropertyName, string matchPropertyValue, string propertyName)
        {
            NodeLabel = nodeLabel;
