...
namespace DFC.ServiceTaxonomy.GraphLookup.Neo4J.Queries
{
    ...
    public class Neo4JLookupQuery : IQuery<LookupRecord>
    {
        ...
        public Neo4JLookupQuery(string displayFieldSearchTerm, string nodeLabel, string displayFieldName, string valueFieldName)
        {
...
limit 50");
        ...
        public static implicit operator Query(Neo4JLookupQuery q) => q.Query;
