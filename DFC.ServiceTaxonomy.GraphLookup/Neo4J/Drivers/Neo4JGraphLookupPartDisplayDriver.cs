...
using DFC.ServiceTaxonomy.GraphLookup.Neo4J.Queries;
...
namespace DFC.ServiceTaxonomy.GraphLookup.Neo4J.Drivers
{
    public class Neo4JGraphLookupPartDisplayDriver : ContentPartDisplayDriver<GraphLookupPart>
    {
        private readonly IGraphCluster _graphCluster;
        private readonly IContentDefinitionManager _contentDefinitionManager;

        public Neo4JGraphLookupPartDisplayDriver(IGraphCluster graphCluster, IContentDefinitionManager contentDefinitionManager)
        {
        ...
        private async Task<string?> GetNodeValue(string id, GraphLookupPartSettings settings)
        {
            ...
            var results = await _graphCluster.Run(GraphReplicaSetNames.Published, new Neo4JGetPropertyOnNodeQuery(
                settings.NodeLabel!,
