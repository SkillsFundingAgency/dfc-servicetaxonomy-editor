...
namespace DFC.ServiceTaxonomy.GraphLookup.CosmosDb.Drivers
{
    public class CosmosDbGraphLookupPartDisplayDriver : ContentPartDisplayDriver<GraphLookupPart>
    {
        private readonly IGraphCluster _graphCluster;
        private readonly IContentDefinitionManager _contentDefinitionManager;

        public CosmosDbGraphLookupPartDisplayDriver(IGraphCluster graphCluster, IContentDefinitionManager contentDefinitionManager)
        {
        ...
        private async Task<string?> GetNodeValue(string id, GraphLookupPartSettings settings)
        {
            ...
            var results = await _graphCluster.Run(GraphReplicaSetNames.Published, new CosmosDbGetPropertyOnNodeQuery(
                settings.NodeLabel!,
