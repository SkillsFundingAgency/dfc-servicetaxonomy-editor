...
namespace DFC.ServiceTaxonomy.UnitTests.CompUi
{
    public class EventGridHandlerTest
    {
        ...
        {
            var contentData = new RelatedContentData
            {
                ...
                ContentType = "Header",
                FullPageUrl = "https://www.test.com/index",
                GraphSyncId = "Test"
            };

            await _eventGridHandler.SendEventMessageAsync(contentData, ContentEventType.StaxCreate);
