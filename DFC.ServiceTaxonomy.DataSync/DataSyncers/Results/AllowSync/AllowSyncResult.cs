namespace DFC.ServiceTaxonomy.DataSync.DataSyncers.Results.AllowSync
{
    public enum AllowSyncResult
    {
        ...
        /// As neo4j doesn't support 2 phase commit, or write transactions across data syncs (even in fabric),
        /// we allow components to block a sync before we attempt to sync.
        /// This allows us to keep OC's db, and the published and preview data syncs consistent
