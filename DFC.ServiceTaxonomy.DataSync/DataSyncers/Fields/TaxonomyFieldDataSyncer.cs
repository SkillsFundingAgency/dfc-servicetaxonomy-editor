...
namespace DFC.ServiceTaxonomy.DataSync.DataSyncers.Fields
{
    ...
    /// </remarks>
    public class TaxonomyFieldDataSyncer : IContentFieldDataSyncer
    {
        ...
        public TaxonomyFieldDataSyncer(IServiceProvider serviceProvider)
        {
...
#pragma warning restore S1848
            ...
            IValidateAndRepairContext context)
        {
            ...
            {
                return (false, $"expecting {contentItemIds.Count} relationships of type {termRelationshipType} in data sync, but found {actualRelationships.Length}");
            }
            ...
            // return context.DataSyncValidationHelper.StringArrayContentPropertyMatchesNodeProperty(
            //     TagNames,
            //     contentItemField,
