...
{
    public class DataSyncContentHandler : ContentHandlerBase
    {
        private readonly ISyncOrchestrator _syncOrchestrator;
        private readonly IDeleteOrchestrator _deleteOrchestrator;
        private readonly ISession _session;
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly ILogger<DataSyncContentHandler> _logger;

        public DataSyncContentHandler(
            ISyncOrchestrator syncOrchestrator,
            IDeleteOrchestrator deleteOrchestrator,
            ISession session,
            IHttpContextAccessor httpContextAccessor,
            ILogger<DataSyncContentHandler> logger)
        {
