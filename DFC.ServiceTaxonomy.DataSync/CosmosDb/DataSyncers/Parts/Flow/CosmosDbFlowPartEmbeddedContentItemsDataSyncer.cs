...
namespace DFC.ServiceTaxonomy.DataSync.CosmosDb.DataSyncers.Parts.Flow
{
    public class CosmosDbFlowPartEmbeddedContentItemsDataSyncer : CosmosDbEmbeddedContentItemsDataSyncer, IFlowPartEmbeddedContentItemsDataSyncer
    {
        ...
        public CosmosDbFlowPartEmbeddedContentItemsDataSyncer(
            IContentDefinitionManager contentDefinitionManager,
            ISyncNameProvider statelessSyncNameProvider,
            IServiceProvider serviceProvider,
            ILogger<CosmosDbFlowPartEmbeddedContentItemsDataSyncer> logger)
