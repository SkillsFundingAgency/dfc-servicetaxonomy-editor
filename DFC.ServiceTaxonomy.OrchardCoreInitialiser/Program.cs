    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var p = new OptionSet {
                ...
                { "d|databasetype=", "The database type for the installation", d => databaseType = d },
                { "t|tableprefix=", "The table prefix for sql server installations only", t => tablePrefix = t },
                { "c|connectionstring=", "The sql connection string for sql server installations only", c => sqlConnectionString = c },
